...
def filter_sarif(input_file, output_file, exclude_paths):
    ...
    for run in sarif['runs']:
        for result in run['results']:
            analyzed_file_path = result['locations'][0]['physicalLocation']['artifactLocation']['uri']
...
if __name__ == "__main__":
    ...
    parser.add_argument('exclude_paths_file', type=str, help='File with paths to exclude. One path per line')
    parser.add_argument('-o', '--output', type=str, help='Output sarif file (default: <input>.filtered)')
